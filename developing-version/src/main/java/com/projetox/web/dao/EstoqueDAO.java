...
public class EstoqueDAO {
    ...
    public void salvar(Estoque e) {
        ...
        try {
            stmt = con.prepareStatement("INSERT INTO dadosEstoque(DS_DESCRICAO,DS_FILIAL) VALUE (?,?);");
    ...
    public List<Estoque> consultar(){
        ...
        try{
            stmt = con.prepareStatement("SELECT * FROM dadosEstoque");
    ...
    public List<Estoque> consultarPorDescricao(String descricao){
        ...
        try{
            stmt = con.prepareStatement("SELECT * FROM dadosEstoque WHERE DS_DESCRICAO LIKE ?;");
    ...
    public void atualizar(Estoque e){
        ...
        try{
            stmt = con.prepareStatement("UPDATE dadosEstoque SET DS_DESCRICAO = ?, DS_FILIAL = ? WHERE PK_ID = ?");
    ...
    public void deletar(int id){
        ...
        try{
           stmt = con.prepareStatement("DELETE FROM dadosEstoque WHERE PK_ID = ?;");
