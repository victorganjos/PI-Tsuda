...
<html>
    ...
    <body>
        <div style="background:#4072A6 !important" class="jumbotron jumbotron-fluid">
            <div class="container">
                <h1 class="display-4" style="color: #FCFCFC">Livraria Tades: Excluir Filial</h1>
            </div>
        </div>    
        <div class="container">
            <h2>Excluir Filial</h2>
            <br>
            <form action="excluir-filial" method="post">
                <c:forEach items="${consulta}" var="consulta">
                    ...
                    <script>
                        function alerta()
                        {
                            alert("Exclusão do Filial realizada com sucesso!");
                        }
                    </script>
                </div>        
            </form>
        ...
        <div class="container">
            ...
            <input class="btn btn-info btn-sm" type="submit" value="Consultar filial" OnClick="parent.location.href = 'consultar-filial'">
        </div>
    </body>
</html>
